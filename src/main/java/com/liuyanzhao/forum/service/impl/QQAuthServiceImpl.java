...
public class QQAuthServiceImpl extends DefaultAuthServiceImpl implements QQAuthService {
    ...
    private static final String API_KEY = "101472393"; // QQ 互联应用管理中心的 APP ID
    private static final String API_SECRET = "58a0d6367df2e779de9df57c2f00e572"; // QQ 互联应用管理中心的 APP Key
